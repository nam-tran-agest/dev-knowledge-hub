...
import { LogIn, LogOut, Shield, Sliders } from 'lucide-react'
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-60 p-2">
                    ...
                    <DropdownMenuItem
                        ...
                        className="text-destructive hover:text-white hover:bg-destructive/20 focus:text-destructive focus:bg-destructive/20 cursor-pointer text-xs font-mono"
                    >
