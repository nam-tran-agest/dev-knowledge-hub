    ...
    <div className="relative w-full group">
      <input
        ...
        className={cn(
          ...
          "cyber-clip-button border border-primary/30 bg-[#040612]/80 px-3.5 py-2 h-10 w-full min-w-0 text-sm font-mono text-slate-200 shadow-inner transition-all outline-none",
